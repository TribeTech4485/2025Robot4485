...
public class Drivetrain extends SwerveDriveBase {
	public Drivetrain() {
		super(Units.inchesToMeters(Constants.Swerve.sideLength), Units.inchesToMeters(Constants.Swerve.sideLength), new SwerveModule[] {
				new SwerveModule(new CANSparkMax(Constants.Wirings.swerveModule2DriveMotor, MotorType.kBrushless),
				...
				new SwerveModule(new CANSparkMax(Constants.Wirings.swerveModule1DriveMotor, MotorType.kBrushless),
				...
				new SwerveModule(new CANSparkMax(Constants.Wirings.swerveModule3DriveMotor, MotorType.kBrushless),
				...
				new SwerveModule(new CANSparkMax(Constants.Wirings.swerveModule4DriveMotor, MotorType.kBrushless),
